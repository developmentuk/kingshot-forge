    ...
    <section className="section page-section release-notes-page">
      ...
      <article className="release-entry release-entry--latest">
        ...
        <div className="release-entry__sections">
          ...
          <section><h3>Sprint 8.0C — Forge Contributors</h3><ul><li>Shared workspace cards, switcher and sidebar now use the dark Forge visual contract with compact operational density.</li><li>Join Forge is available at <Link to="/join">/join</Link> with data-driven role pages and explicit unpaid/voluntary disclosure.</li><li>Secure application persistence, Operations review and onboarding remain in development; the public catalogue collects no application data.</li></ul></section>
        </div>
      </article>
