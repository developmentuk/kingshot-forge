...
export const DEFAULT_CALIBRATION: CalibrationConfiguration = {
  space: calibration({ advanceCells: .6, fontWeight: 400 }),
  ...
  'full-width': calibration({ advanceCells: 2, glyphScale: 1.04, horizontalScale: .82, fontFamily: GAME_FULL_WIDTH_STACK }),
  unicode: calibration({ horizontalScale: .9, fontFamily: GAME_FULL_WIDTH_STACK }),
  emoji: calibration({ advanceCells: 2, glyphScale: 1.02, verticalScale: 1.02, fontFamily: EMOJI_STACK, fontWeight: 400 }),
