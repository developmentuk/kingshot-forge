...
assert.ok(app.includes('<Route path="companion/pets" element={<PetCompanionPage />} />'))
assert.ok(app.includes('<Route path="companion/pets/:petKey" element={<PetCompanionPage />} />'))
