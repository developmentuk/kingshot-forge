...
const companionItemMedia = readFileSync('src/features/companion/CompanionItemMedia.tsx', 'utf8')
...
assert.match(companionItemMedia, /failedSource !== mediaSource/u)
assert.match(companionItemMedia, /setFailedSource\(mediaSource\)/u)
