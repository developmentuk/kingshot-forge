...
assert.match(parent, /The API result has not overwritten the screenshot evidence/)
assert.match(parent, /Kingshot State/)
console.log('PASS VISION-LINK-007: V6 five-field contract, State-aware lookup and unverified fallback containment')
