...
assert.equal(reverseRepairs(repaired.text, repaired.operations), source)
assert.equal(hashText(source), hashText(repaired.text))
console.log('ART-001 rendering tests passed: preservation, Unicode diagnostics and non-mutating prediction.')
