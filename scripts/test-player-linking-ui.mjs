...
assert.match(parent, /Player ID and State are both required/)
...
console.log('PASS player-linking-ui: OCR prefills Player ID and State, preserves evidence, and gates unverified fallback')
