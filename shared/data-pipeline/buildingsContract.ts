...
export const buildingsContract: DatasetContract = {
  ...
  description: 'Canonical buildings, companion media and per-level progression records.',
  ...
  optionalColumns: {
    buildings_catalog: ['image_url', 'image_alt_text', 'image_credit', 'image_source_url', 'image_license'],
    buildings_import: ['max_hero_level', 'training_capacity', 'rally_capacity', 'ally_help_count', 'training_speed_percent', 'troop_deploy_capacity', 'reinforcement_capacity'],
  },
  fields: {
    ...
    image_url: { type: 'url', nullable: true }, image_alt_text: { type: 'string', nullable: true }, image_credit: { type: 'string', nullable: true }, image_source_url: { type: 'url', nullable: true }, image_license: { type: 'string', nullable: true },
    ...
    truegold: { type: 'number', nullable: true }, tempered_truegold: { type: 'number', nullable: true }, bread: { type: 'number', nullable: true }, wood: { type: 'number', nullable: true }, stone: { type: 'number', nullable: true }, iron: { type: 'number', nullable: true }, upgrade_time_seconds: { type: 'number', nullable: true }, power: { type: 'number', nullable: true },
  },
