...
Evidence storage is provisioned but not accepted. The halted synthetic activation and exact cleanup remain separate owner-approved operations; worker/OCR execution is not part of D1A3.
