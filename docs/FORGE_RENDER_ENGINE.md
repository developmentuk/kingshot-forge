...
Forge Render Engine 2.0 is the canonical rendering subsystem for Kingshot-compatible artwork previews.
...
5. Classify each cell as space, ASCII, box drawing, Unicode or emoji.
...
They do not alter the artwork matrix.
...
- Testing Art — mixed emoji and ASCII scene
- Alliance Cat Slide — ASCII scene and dialogue
- Like My Island — dense emoji artwork
