...
| MIME/extension spoofing | Allowlist, intent match, object HEAD match, dimensions and digest verification | Test each MIME and malformed extension |
...
| Unverified object referenced as evidence | `verified_at` only after exact HEAD/SHA-256 comparison | Corrective migration and completion transaction |
...
| Automatic canonical mutation | Provider/service has no canonical write operation | Worker/proposal boundary review |
