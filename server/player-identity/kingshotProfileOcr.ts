...
import { KINGSHOT_PROFILE_V1_REGIONS, KINGSHOT_PROFILE_V2_REGIONS, KINGSHOT_PROFILE_V3_REGIONS, KINGSHOT_PROFILE_V4_REGIONS, type KingshotProfileRegionConfig } from '../../shared/domains/player-identity/kingshotProfileMapping.js'
...
export function profileRegionBindings(version: 'v1' | 'v2' | 'v3' | 'v4' = 'v2'): VisionRegionBinding[] {
  const regions = version === 'v1' ? KINGSHOT_PROFILE_V1_REGIONS : version === 'v3' ? KINGSHOT_PROFILE_V3_REGIONS : version === 'v4' ? KINGSHOT_PROFILE_V4_REGIONS : KINGSHOT_PROFILE_V2_REGIONS
  const mappingId = version === 'v1' ? 'account-linking-kingshot-profile-v1' : version === 'v3' ? KINGSHOT_PROFILE_V3_MAPPING_VERSION : version === 'v4' ? KINGSHOT_PROFILE_V4_MAPPING_VERSION : KINGSHOT_PROFILE_V2_MAPPING_ID
